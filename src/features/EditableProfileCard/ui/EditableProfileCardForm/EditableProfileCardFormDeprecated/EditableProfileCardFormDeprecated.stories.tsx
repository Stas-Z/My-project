...
import { EditableProfileCardFormDeprecated } from './EditableProfileCardFormDeprecated'
import { ValidateProfileEror } from '../../../model/consts/editableProfileCardConsts'

export default {
  title:
    'features/Profile/EditableProfileCardForm/EditableProfileCardFormDeprecated',
  component: EditableProfileCardFormDeprecated,
  argTypes: {
    backgroundColor: { control: 'color' },
  },
} as Meta<typeof EditableProfileCardFormDeprecated>

type Template = StoryObj<typeof EditableProfileCardFormDeprecated>
